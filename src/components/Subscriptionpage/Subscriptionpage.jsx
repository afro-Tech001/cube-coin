...
const PLANS = [
  {
    ...
    rate: "62.50 CUBE/hr", rateVal: 62.50,
    subscriptionCubes: 20000,
    dailyEarning: 1500,
    features: ["1,500 CUBE daily", "Entry-level mining", "Daily rewards", "Mobile access", "Community support"],
    badge: "New · Best entry",
  },
  {
    id: 1, name: "Starter", price: 10600,
    rate: "125.00 CUBE/hr", rateVal: 125.00,
    subscriptionCubes: 50000,
    dailyEarning: 3000,
    features: ["3,000 CUBE daily", "Basic mining speed", "Daily rewards", "Mobile access", "Community support"],
  },
  {
    id: 2, name: "Bronze", price: 16200,
    rate: "187.50 CUBE/hr", rateVal: 187.50,
    subscriptionCubes: 100000,
    dailyEarning: 4500,
    features: ["4,500 CUBE daily", "2.5× mining speed", "Daily rewards", "Priority queue", "Email support", "Streak bonuses"],
  },
  {
    id: 3, name: "Silver", price: 22500,
    rate: "250.00 CUBE/hr", rateVal: 250.00,
    subscriptionCubes: 200000,
    dailyEarning: 6000,
    features: ["6,000 CUBE daily", "5× mining speed", "Daily + bonus rewards", "Referral boost +5%", "24/7 chat support", "Streak bonuses", "Early access"],
    featured: true, badge: "Most popular",
  },
  {
    id: 4, name: "Gold", price: 30350,
    rate: "312.50 CUBE/hr", rateVal: 312.50,
    subscriptionCubes: 250000,
    dailyEarning: 7500,
    features: ["7,500 CUBE daily", "9× mining speed", "Double daily rewards", "Referral boost +10%", "VIP support", "Analytics dashboard", "Custom avatar"],
  },
  {
    id: 5, name: "Diamond", price: 50000,
    rate: "408.33 CUBE/hr", rateVal: 408.33,
    subscriptionCubes: 300000,
    dailyEarning: 9800,
    features: ["9,800 CUBE daily", "17.5× mining speed", "Triple daily rewards", "Referral boost +20%", "Dedicated manager", "Full analytics", "NFT badge", "Priority withdrawals", "Lifetime perks"],
  },
];
