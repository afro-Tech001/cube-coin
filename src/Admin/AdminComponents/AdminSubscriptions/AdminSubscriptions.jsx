...
// ── Inline styles (mirrors Subscriptionpage.css tokens) ───────────────────────
const T = {
  bg:         "#050b07",
      ...
      >
        ...
        {sub.payment_status !== "pending" && (
          <div style={{
            ...
            This subscription has already been <strong style={{ color: T.green }}>
              {sub.payment_status}
            </strong>.
          </div>
        )}
...
// };
  ...
  try {
    ...
    console.log("▶ Updating subscription", id, "→", status);
    console.log("▶ Target user_id:", sub.user_id);
    ...
    const updatePayload = status === "approved"
      ? { subscription_status: "approved", plan_name: sub.plan_name, plan_status: "active" }
      : { subscription_status: "rejected", plan_status: "rejected" };
    ...
    const { data: updatedRows, error: profileError } = await supabase
      ...
      .eq("id", sub.user_id)
      .select(); // returns what was actually updated

    console.log("▶ Profile update result:", updatedRows);
    ...
    if (!updatedRows || updatedRows.length === 0) {
      console.error("❌ Profile update returned 0 rows — RLS is blocking it or user_id doesn't match");
      toast.error("Profile update blocked — check RLS policies");
      return;
    }
    ...
    <div style={{
      ...
      <div style={{ maxWidth: 900, margin: "0 auto" }}>
        <div style={{ marginBottom: 28 }}>
          ...
          <h1 style={{ fontSize: "1.9rem", fontWeight: 800, color: T.white,
            ...
            {visible.map(sub => (
              <div
                ...
                onMouseLeave={e => {
                  e.currentTarget.style.borderColor =
                    sub.payment_status === "pending" ? T.warnBd : T.border;
              ...
              >
                ...
                <div style={{
                  ...
                  color: PLAN_COLORS[sub.plan_name] || T.green,
                  flexShrink: 0,
                }}> 
